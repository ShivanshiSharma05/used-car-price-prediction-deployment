...
st.markdown("Enter details to estimate the selling price.")
...
with col1:
    ...
    kms_driven = st.number_input("Kilometers Driven", min_value=0, value=15000)
...
if st.button("Predict Selling Price"):
    payload = {
        ...
        "fuel_type": fuel_type, "seller_type": seller_type, "transmission": transmission, "owner": owner
    }

    try:
        # UPDATE THIS URL to your actual Render service URL
